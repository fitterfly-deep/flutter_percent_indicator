        ...
        children: [
          ...
          if (widget.widgetIndicator != null &&
            ...
            Positioned(
              ...
              top: _containerHeight / 2 - _indicatorHeight - 1.5,
              child: widget.widgetIndicator!,
            ),
        ],
      ),
...
class LinearPercentIndicatorV2 extends StatefulWidget {
  ///Percent value between 0.0 and 1.0
  final double percent;
  final double? width;
  ...
  @override
  State<LinearPercentIndicatorV2> createState() => _LinearPercentIndicatorV2State();
}

class _LinearPercentIndicatorV2State extends State<LinearPercentIndicatorV2> with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  AnimationController? _animationController;
  Animation? _animation;
  double _percent = 0.0;
  final _containerKey = GlobalKey();
      ...
      child: Stack(
        ...
        children: [
          ...
          if (widget.widgetIndicator != null &&
            ...
            Positioned(
              right: widget.isRTL ? percentPositionedHorizontal : null,
              left: !widget.isRTL ? (percentPositionedHorizontal < 30)? (percentPositionedHorizontal + 10) : (percentPositionedHorizontal - 15) : null,
